...
public class TopicLoader {
   ...
   public static void runProducer() throws IOException {
        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            List<ElectronicOrder> electronicOrders = Arrays.asList(electronicOrderOne, electronicOrderTwo, electronicOrderThree, electronicOrderFour, electronicOrderFive);
