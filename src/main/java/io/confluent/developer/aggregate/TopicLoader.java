...
public class TopicLoader {
    ...
    public static void runProducer() throws IOException {
        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            CreateTopicsResult topicResult=adminClient.createTopics(topics);
            System.out.println("topicResult status:"+topicResult.all().isDone());
            DescribeTopicsResult result=adminClient.describeTopics(Arrays.asList(outputTopic+","+outputTopic.split(",")));
            System.out.println("status:"+result.all().isDone());
