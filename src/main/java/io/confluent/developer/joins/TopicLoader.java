...
public class TopicLoader {
    ...
    public static void runProducer() throws IOException {
        ...
        try(Admin adminClient = Admin.create(properties);
            ...
            List<NewTopic> topics = Arrays.asList(StreamsUtils.createTopic(leftSideTopic),
            ...
            ApplianceOrder applianceOrderTwo = ApplianceOrder.newBuilder()
                                                             ...
                                                             .setUserId("10261999")
                                                             .setTime(Instant.now().toEpochMilli()).build();
            List<ApplianceOrder> applianceOrders = Arrays.asList(applianceOrderOne, applianceOrderTwo);
            ...
            List<ElectronicOrder> electronicOrders = Arrays.asList(electronicOrderOne, electronicOrderTwo);
